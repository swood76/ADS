...
module nios_mm_interconnect_0 (
		...
		input  wire [14:0] nios2e_data_master_address,               //                 nios2e_data_master.address
		...
		input  wire [14:0] nios2e_instruction_master_address,        //          nios2e_instruction_master.address
	...
	wire  [14:0] nios2e_data_master_translator_avalon_universal_master_0_address;              // nios2e_data_master_translator:uav_address -> nios2e_data_master_agent:av_address
	...
	wire  [90:0] rsp_mux_src_data;                                                             // rsp_mux:src_data -> nios2e_data_master_agent:rp_data
	...
	wire  [14:0] nios2e_instruction_master_translator_avalon_universal_master_0_address;       // nios2e_instruction_master_translator:uav_address -> nios2e_instruction_master_agent:av_address
	...
	wire  [90:0] rsp_mux_001_src_data;                                                         // rsp_mux_001:src_data -> nios2e_instruction_master_agent:rp_data
	...
	wire  [14:0] nios2e_debug_mem_slave_agent_m0_address;                                      // nios2e_debug_mem_slave_agent:m0_address -> nios2e_debug_mem_slave_translator:uav_address
	...
	wire  [91:0] nios2e_debug_mem_slave_agent_rf_source_data;                                  // nios2e_debug_mem_slave_agent:rf_source_data -> nios2e_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [91:0] nios2e_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2e_debug_mem_slave_agent_rsp_fifo:out_data -> nios2e_debug_mem_slave_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                            // cmd_mux:src_valid -> nios2e_debug_mem_slave_agent:cp_valid
	wire  [90:0] cmd_mux_src_data;                                                             // cmd_mux:src_data -> nios2e_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                            // nios2e_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [4:0] cmd_mux_src_channel;                                                          // cmd_mux:src_channel -> nios2e_debug_mem_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                    // cmd_mux:src_startofpacket -> nios2e_debug_mem_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                      // cmd_mux:src_endofpacket -> nios2e_debug_mem_slave_agent:cp_endofpacket
	...
	wire         cmd_mux_001_src_valid;                                                        // cmd_mux_001:src_valid -> uart_avalon_jtag_slave_agent:cp_valid
	wire  [90:0] cmd_mux_001_src_data;                                                         // cmd_mux_001:src_data -> uart_avalon_jtag_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                        // uart_avalon_jtag_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                      // cmd_mux_001:src_channel -> uart_avalon_jtag_slave_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                // cmd_mux_001:src_startofpacket -> uart_avalon_jtag_slave_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                  // cmd_mux_001:src_endofpacket -> uart_avalon_jtag_slave_agent:cp_endofpacket
	...
	wire  [90:0] cmd_mux_004_src_data;                                                         // cmd_mux_004:src_data -> switch_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                        // switch_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                      // cmd_mux_004:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [90:0] nios2e_data_master_agent_cp_data;                                             // nios2e_data_master_agent:cp_data -> router:sink_data
	...
	wire  [90:0] nios2e_instruction_master_agent_cp_data;                                      // nios2e_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire         nios2e_debug_mem_slave_agent_rp_valid;                                        // nios2e_debug_mem_slave_agent:rp_valid -> router_002:sink_valid
	wire  [90:0] nios2e_debug_mem_slave_agent_rp_data;                                         // nios2e_debug_mem_slave_agent:rp_data -> router_002:sink_data
	wire         nios2e_debug_mem_slave_agent_rp_ready;                                        // router_002:sink_ready -> nios2e_debug_mem_slave_agent:rp_ready
	wire         nios2e_debug_mem_slave_agent_rp_startofpacket;                                // nios2e_debug_mem_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         nios2e_debug_mem_slave_agent_rp_endofpacket;                                  // nios2e_debug_mem_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         uart_avalon_jtag_slave_agent_rp_valid;                                        // uart_avalon_jtag_slave_agent:rp_valid -> router_003:sink_valid
	wire  [90:0] uart_avalon_jtag_slave_agent_rp_data;                                         // uart_avalon_jtag_slave_agent:rp_data -> router_003:sink_data
	wire         uart_avalon_jtag_slave_agent_rp_ready;                                        // router_003:sink_ready -> uart_avalon_jtag_slave_agent:rp_ready
	wire         uart_avalon_jtag_slave_agent_rp_startofpacket;                                // uart_avalon_jtag_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         uart_avalon_jtag_slave_agent_rp_endofpacket;                                  // uart_avalon_jtag_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [90:0] switch_s1_agent_rp_data;                                                      // switch_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [90:0] cmd_demux_001_src1_data;                                                      // cmd_demux_001:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [90:0] cmd_demux_001_src2_data;                                                      // cmd_demux_001:src2_data -> cmd_mux_002:sink0_data
	...
	wire  [90:0] cmd_demux_001_src3_data;                                                      // cmd_demux_001:src3_data -> cmd_mux_003:sink0_data
	...
	wire  [90:0] cmd_demux_001_src4_data;                                                      // cmd_demux_001:src4_data -> cmd_mux_004:sink0_data
	...
	wire  [90:0] rsp_demux_001_src0_data;                                                      // rsp_demux_001:src0_data -> rsp_mux_001:sink1_data
	...
	wire  [90:0] rsp_demux_002_src0_data;                                                      // rsp_demux_002:src0_data -> rsp_mux_001:sink2_data
	...
	wire  [90:0] rsp_demux_003_src0_data;                                                      // rsp_demux_003:src0_data -> rsp_mux_001:sink3_data
	...
	wire  [90:0] rsp_demux_004_src0_data;                                                      // rsp_demux_004:src0_data -> rsp_mux_001:sink4_data
	...
	wire         nios2e_debug_mem_slave_agent_rdata_fifo_src_valid;                            // nios2e_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] nios2e_debug_mem_slave_agent_rdata_fifo_src_data;                             // nios2e_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         nios2e_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter:in_0_ready -> nios2e_debug_mem_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                // avalon_st_adapter:out_0_valid -> nios2e_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                 // avalon_st_adapter:out_0_data -> nios2e_debug_mem_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                // nios2e_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                // avalon_st_adapter:out_0_error -> nios2e_debug_mem_slave_agent:rdata_fifo_sink_error
	wire         uart_avalon_jtag_slave_agent_rdata_fifo_src_valid;                            // uart_avalon_jtag_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] uart_avalon_jtag_slave_agent_rdata_fifo_src_data;                             // uart_avalon_jtag_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         uart_avalon_jtag_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_001:in_0_ready -> uart_avalon_jtag_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                            // avalon_st_adapter_001:out_0_valid -> uart_avalon_jtag_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                             // avalon_st_adapter_001:out_0_data -> uart_avalon_jtag_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                            // uart_avalon_jtag_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                            // avalon_st_adapter_001:out_0_error -> uart_avalon_jtag_slave_agent:rdata_fifo_sink_error
